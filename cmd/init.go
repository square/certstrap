...
func initAction(c *cli.Context) {
	...
	crt, err := pkix.CreateCertificateAuthorityWithOptions(key, c.String("organizational-unit"), expiresTime, c.String("organization"), c.String("country"), c.String("province"), c.String("locality"), c.String("common-name"), c.StringSlice("permit-domain"), pkix.WithPathlenOption(c.Int("pathlen"), c.Bool("exclude-path-length")))
