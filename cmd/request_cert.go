...
func NewCertRequestCommand() cli.Command {
	return cli.Command{
		...
		Flags: []cli.Flag{
			...
			cli.StringFlag{"locality", "", "Certificate locality", ""},
			cli.StringFlag{"common-name", "", "Certificate common name, will be IP address or domain if left empty", ""},
			cli.StringFlag{"organizational-unit", "", "Certificate organizational unit", ""},
			cli.StringFlag{"province", "", "Certificate state/province", ""},
